...
- **BUG-066 — un refus s'effaçait quand on cliquait « + Ajouter ».** `handleAjouter` indexait son écriture sur l'identifiant **tout juste frappé**, qui n'entre jamais dans le document quand elle échoue : le bandeau devenait inaffichable *et* évinçait le refus légitime en cours. L'indexation d'un refus avait été pensée pour les chemins d'**édition**, où l'entité existe déjà, puis appliquée telle quelle au chemin de **création**, où elle n'existe pas encore. Trouvé par la revue de PR du `tech-lead`.
