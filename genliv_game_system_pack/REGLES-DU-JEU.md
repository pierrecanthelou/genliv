...
> - **Schéma de création (à câbler maintenant)** — ce que l'auteur configure : les 7 caractéristiques, le Tier de Challenge d'un jet, le bloc de stats d'un monstre, l'équipement. Ces éléments redéfinissent le placeholder bas-niveau actuel de l'éditeur.
...
Le héros est défini par **7 caractéristiques principales**, plafonnées à **12**.
...
| `IG` | Ingéniosité | Débrouillardise et perception |
| `CA` | Caractère | Volonté et résilience mentale |

### Création & état de santé
- **Génération** : l'ordinateur lance **2D4** pour chaque caractéristique. Le joueur répartit ensuite un bonus de **1D4** sur **3 caractéristiques** de son choix.
