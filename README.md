...
src/
  ...
  features/         # isolated feature modules; talk to the rest only through brain/
    ...
    dossier-fiches/     # n° 4 — 3/6: PanneauPersonnages + FichePersonnage + Accordion (8 slots, 3 filled): name, camp, plan, objectif_id, identity prose, stats (8 keys, total-when-present) + derived PV
