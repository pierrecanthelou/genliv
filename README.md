...
src/
  ...
  features/         # isolated feature modules; talk to the rest only through brain/
    ...
    dossier-canon/      # n° 3 — 2/4: Canon + Depart panels (Select-driven lieu_id, opening text) via DossierService.update()
