...
src/
  ...
  features/         # isolated feature modules; talk to the rest only through brain/
    ...
    dossier-fiches/     # n° 4 — 1/5: PanneauPersonnages + FichePersonnage + Accordion (8 slots, 1 filled): name, camp, plan, objectif_id
