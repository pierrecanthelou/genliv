...
src/
  ...
  features/         # isolated feature modules; talk to the rest only through brain/
    ...
    dossier-canon/      # n° 3 — 3/4: Canon + Depart + Objectifs panels (ObjectifsCanon: camp Select, D1 warning derived from validateDossier) via DossierService.update()
