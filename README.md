...
src/
  ...
  features/         # isolated feature modules; talk to the rest only through brain/
    ...
    dossier-canon/      # n° 3 — 1/4: Canon panel (synopsis/accroche/ton/interdits) via DossierService.update()
