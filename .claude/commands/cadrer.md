...
## Étape 0 — cadrage
Lis `CLAUDE.md`, `features/README.md`, les `specification.json` voisines (pour le format et le ton), et la source qui décrit cette feature — pour la bascule IA, la section correspondante du plan de bascule. Résume en 10 lignes : l'intention `$2`, ce qui existe déjà et sera réutilisé, ce qui sera remplacé, les features voisines impactées.
...
Mets aussi à jour le tableau d'ordre de construction de `features/README.md`.
