...
import { PanneauIndices, PanneauJalonsFins } from './features/dossier-registres'
...
export function App(): JSX.Element {
	...
	const content =
		route.name === 'editor' ? (
			...
			// Canon, Départ, Personnages, Lieux, Objets, Indices and Jalons & fins
			// panels are injected HERE, from the composition root: bascule-editeur
			// never imports dossier-canon, dossier-fiches, dossier-objets or
			// dossier-registres, and vice versa (KR-184).
			<DossierEditorScreen
				key={route.dossierId}
